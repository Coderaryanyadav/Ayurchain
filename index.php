<?php
// ====================================================================
// Home Landing Page (Phase 15 Polished UI)
...
// Fetch summary metrics for Home Page
$total_medicines  = 0;
$total_blockchain = 0;
$total_batches    = 0;
        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="verify.php" class="btn btn-gold btn-lg shadow">
                        <i class="fa-solid fa-shield-check me-2"></i>Verify Medicine Batch
                    </a>
                    <a href="medicines.php" class="btn btn-outline-light btn-lg fw-semibold">
                        <i class="fa-solid fa-search me-2"></i>Search Directory
                    </a>
                    <?php if (!is_admin_logged_in()): ?>
                        <a href="login.php" class="btn btn-ayur btn-lg shadow-sm">
...
<div class="container">
    ...
    <div class="card card-ayur p-4 mb-5 shadow-sm border-start border-5 border-warning">
        ...
        <form method="GET" action="medicines.php" class="row g-2">
            <div class="col-md-9">
                <input type="text" name="search" class="form-control form-control-lg border-2" placeholder="Type Medicine Name, Botanical Name, ID, or Batch Number..." required>
            </div>
            <div class="col-md-3">
                <button type="submit" class="btn btn-ayur btn-lg w-100 fw-bold">
                    <i class="fa-solid fa-search me-1"></i> Search Directory
                </button>
            </div>
        </form>
    </div>
