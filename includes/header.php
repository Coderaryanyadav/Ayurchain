<?php
// ====================================================================
// Header & Navigation Include (Phase 15 Polished UI)
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarAyurContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if ($current_page === 'medicines.php') echo 'active'; ?>" href="medicines.php">
            <i class="fa-solid fa-pills me-1"></i> Medicines Directory
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if ($current_page === 'verify.php') echo 'active'; ?>" href="verify.php">
            <i class="fa-solid fa-shield-halved me-1"></i> Verify Medicine
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if ($current_page === 'history.php') echo 'active'; ?>" href="history.php">
            <i class="fa-solid fa-cubes me-1"></i> Blockchain Records
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if ($current_page === 'about.php') echo 'active'; ?>" href="about.php">
      ...
      <ul class="navbar-nav ms-auto align-items-lg-center gap-2">
        <?php if (is_admin_logged_in()): ?>
          <li class="nav-item">
            <a class="btn btn-warning btn-sm text-dark font-weight-bold px-3 <?php if ($current_page === 'dashboard.php') echo 'active'; ?>" href="dashboard.php">
              <i class="fa-solid fa-gauge-high me-1"></i> Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="btn btn-outline-light btn-sm px-3" href="add_medicine.php">
              <i class="fa-solid fa-plus me-1"></i> Add Medicine
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if ($current_page === 'profile.php') echo 'active'; ?>" href="profile.php" title="Admin Profile">
              <i class="fa-solid fa-user-gear text-warning me-1"></i> Profile
            </a>
          </li>
          <li class="nav-item">
            <a class="btn btn-outline-danger btn-sm text-white px-3" href="logout.php">
              <i class="fa-solid fa-right-from-bracket me-1"></i> Logout
            </a>
          </li>
        <?php else: ?>
          <li class="nav-item">
            <a class="btn btn-gold btn-sm px-3 shadow-sm" href="login.php">
